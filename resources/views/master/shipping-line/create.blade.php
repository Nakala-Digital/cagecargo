@extends('layouts.app')
@section('title', 'Tambah Shipping Line')
@section('content')
<div class="max-w-2xl">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-navy">Tambah Shipping Line</h2>
        <p class="text-gray-500">Data shipping line baru</p>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form method="POST" action="{{ route('master.shipping-line.store') }}">
            @csrf
