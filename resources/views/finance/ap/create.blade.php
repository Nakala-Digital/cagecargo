@extends('layouts.app')
@section('title', 'Catat AP')
@section('content')
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-navy">Catat A/P</h2>
            <p class="text-gray-500">Utang usaha armada ke vendor</p>
        </div>
        <a href="{{ route('finance.ap.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-700 hover:bg-gray-50">Kembali</a>
    </div>

    <div class="bg-white rounded-xl shadow-sm p-6">
        <form method="POST" action="{{ route('finance.ap.store') }}">
            @csrf
            <div class="space-y-4">
                <div>
                ...
                <div>
                    ...
                    <select name="job_order_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-teal focus:border-teal">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('finance.ap.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-700 hover:bg-gray-50">Batal</a>
